module github.com/authaas/token-issuer-service-connect-go
...
require (
	...
	github.com/authaas/token-issuer-service-bindings-connect-go v0.1.0
	github.com/authaas/token-jwt-go v0.4.0
